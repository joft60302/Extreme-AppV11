...
useEffect(()=>{
    const Scroll=()=>{
        ...
        else if(window.scrollY>64){SetPosition('rgba(255, 255, 255,0.25)'); SetColor('primary');SetShow(1);setOpen(false);}
        else {SetPosition('transparent'); SetColor('primary');SetShow(2);setOpen(false);}
    }
