...
useEffect(()=>{
    const Scroll=()=>{
        if(window.scrollY>200){SetPosition('#fafafa'); SetColor('secondary');SetShow(0);setOpen(false);}
        else if(window.scrollY>150){SetPosition('rgba(255, 255, 255,0.75)'); SetColor('secondary');SetShow(0);setOpen(false);}
        else if(window.scrollY>50){SetPosition('rgba(255, 255, 255,0.25)'); SetColor('primary');SetShow(1);setOpen(false);}
        else {SetPosition('transparent'); SetColor('primary');SetShow(1);setOpen(false);}
    }
